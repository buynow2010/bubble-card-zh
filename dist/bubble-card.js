                ...
                <div class="export-section">
                    ...
                    <div class="bubble-info">
                      ...
                      <div class="content">
                        ...
                        <a href="https://github.com/ha-china/bubble-card-zh/discussions/categories/share-your-modules" target="_blank">Share your Modules</a> category.
                ...
                <div class="content">
                    ...
                    ${t.light_transition?c.qy`
                        <div class="bubble-info">
                            ...
                            <div class="content">
                                <p><b>Important:</b> 此功能仅适用于支持以下属性的灯光： 
    ...
    `}(e)}
            ...
            <ha-expansion-panel outlined style="display: ${"slider"===e._config.button_type&&e._config.tap_to_slide?"none":""}">
                ...
                <div class="content">
                    ...
                    ${e.makeActionPanel("按住动作",o,"name"===e._config.button_type||"slider"===e._config.button_type?"none":"more-info","button_action")}
                </div>
            </ha-expansion-panel>
            ...
            <ha-expansion-panel outlined>
                ...
                <div class="content">
                    ...
                    <div class="bubble-info">
                        ...
                        <div class="content">
                            <p>您可以完全隐藏弹出窗口页眉，包括关闭按钮。隐藏后要关闭它，可以在弹出窗口内长划动或点击外部区域。</p>
                        </div>
                    </div>
                    ...
                    <ha-expansion-panel outlined>
                        ...
                        <div class="content"> 
                            ...
                            <ha-formfield .label="隐藏弹出背景（需要刷新）">
                                ...
                                ></ha-switch>
                                <div class="mdc-form-field">
                                    <label class="mdc-label">隐藏弹出背景（需要刷新）</label> 
                                </div>
                            </ha-formfield>
                            <div class="bubble-info">
                                <h4 class="bubble-section-title">
                                ...
                                <div class="content">
                                    ...
                                    <p>您可以通过在仪表板上的第一个弹出窗口中开启此设置，一次性对所有弹出窗口启用此项。</p>
                                    <p><b>如果您在打开/关闭弹出窗口时遇到性能问题，建议将其隐藏。</b></p>
                                </div>
                            </div>
                        </div>
                    </ha-expansion-panel>
            ...
            <div class="bubble-info-container">
                <div class="bubble-info">
                    ...
                    <div class="content">
                        ...
                        <p><b>您也可以观看此 <a href="https://www.youtube.com/watch?v=7mOV7BfWoFc" target="_blank" rel="noopener noreferrer">视频</a>，它解释了如何创建您的第一个弹出窗口</b> (this video is outdated, you don't need to add a vertical stack anymore).</p>
                    </div>
                </div>
                ...
                <div class="bubble-info warning">
                    ...
                    <div class="content">
                        <p>为避免与视图不对齐，请将此卡片放在仪表板所有其他卡片之后。您无法从其他视图触发它。</p>
                        <p>如果您的弹出内容在页面加载期间出现在屏幕上，<a href="https://github.com/Clooos/Bubble-Card#pop-up-initialization-fix" target="_blank" rel="noopener noreferrer">您可以安装此修复程序</a>（推荐）。</p>
                    </div>
                </div>
            </div>
            ${e.makeVersion()}
  ...
  `}(e,n,o,t);const i="main"===t?e._config.sub_button.main:e._config.sub_button.bottom,a=oe(e,i,o,be),r=ie(e,i,o,be),s=i[o],l=Z(e,s,ce),d=ee(e,s,a,ce),u=i.length;return Q(e,n,o,`sub_button.${t}`,n=>{ue(e,t,e=>{const t=[...e];return t[o]={...t[o]||{},...n},t},be)},a,r,l,d,{panelKeyPrefix:`${t}_button`,buttonTitle:`Button ${o+1}${n.name?` - ${n.name}`:""}`,arrayLength:u})})}
    ...
    <div class="element-actions">
      ...
      `:G({trigger:c.qy`
        ...
        `,items:[{type:"item",icon:"mdi:shape-square-rounded-plus",label:"添加子按钮",onClick:()=>{ue(e,t,t=>[...t,{entity:e._config.entity}],be)}},{type:"item",icon:"mdi:format-list-group-plus",label:"添加分组",onClick:()=>{s()}}]})}
    </div>
    ...
    `})()}
              ...
              <div class="card-content">
                ...
                <div class="module-editor-buttons-container">
                  ...
                  <button 
                    class="icon-button" 
                    style="flex: 1;"
                    @click=${async()=>{try{const t=e._manualYamlContent;if(!t||""===t.trim())return void(0,s.rC)(e,"bubble-card-error",{message:"未提供 YAML 内容"});const n=await(0,_e.m)(e,t);e._showManualImportForm=!1,e._manualYamlContent="",n&&n.moduleId&&(e._recentlyToggledModuleId=n.moduleId,setTimeout(()=>{e._recentlyToggledModuleId=null,e.requestUpdate()},2e3)),e.requestUpdate(),n&&n.moduleId&&requestAnimationFrame(()=>{requestAnimationFrame(()=>{const t=e.shadowRoot?.querySelector(`ha-expansion-panel[data-module-id="${n.moduleId}"]`);t&&t.scrollIntoView({behavior:"smooth",block:"center"})})})}catch(e){console.error("安装手动模块出错：",e)}}}
                  >
                    <ha-icon icon="mdi:content-save"></ha-icon>
                    导入模块
                  </button>
                    ...
                    ${X(e,t,!!e._expandedPanelStates[t],()=>c.qy`
                      <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="module-actions">
                          ...
                          `:""}
                          <button class="icon-button ${l?"":"disabled"}" @click=${()=>(0,ve.dK)(e,t)} title="编辑模块">
        ...
        <div class="bubble-info">
          ...
          <div class="content">
            ...
            <p><b>If coding isn't your thing</b>, you can also find and install modules made by the community in the <b>模块商店</b>.</p>
          </div>
        </div>
      </div>
    </ha-expansion-panel>
...
`;case"horizontal-buttons-stack":return function(e){if(!e.buttonAdded)for(e.buttonAdded=!0,e.buttonIndex=0;e._config[e.buttonIndex+1+"_link"];)e.buttonIndex++;return c.qy`
    ...
    `}(this);case void 0:return c.qy`
        ...
        `}makeShowState(e=this._config,t="",n=!1,o){const i=e?.entity??this._config.entity??"",a="name"===this._config.button_type,r=i?.startsWith("input_select")||i?.startsWith("select")||e.select_attribute,s="sub_button"===n||"string"==typeof n&&n.startsWith("sub_button"),l=s&&("select"===e?.sub_button_type||!e?.sub_button_type&&r),d=e?.show_attribute?Object.keys(this.hass.states[i]?.attributes||{}).map(e=>{let t=this.hass.states[i];return{label:this.hass.formatEntityAttributeName(t,e),value:e}}):[];return c.qy`
            ...
            `)}
        `}makeDropdown(e,t,n,o,i){if(e.includes("icon")||e.includes("图标"))return c.qy`
                <div class="ha-icon-picker">
                    <ha-icon-picker
                        label="${e}"
            ...
            `;if(e.includes("实体")||e.includes("entity")){let n=[],i=[];switch(this._config.card_type){case"button":default:break;case"cover":n=["cover"];break;case"climate":n=["climate"];break;case"media-player":n=["media_player"];break;case"select":n=["input_select","select"],this._config.select_attribute&&(n=[])}return c.qy`
                <ha-entity-picker
                    label="${e}"
                    .hass="${this.hass}"
            ...
            `}return c.qy`
                ...
                ></ha-form>
          `}_renderConditionalContent(e,t){return e?t:c.qy``}makeActionPanel(e,t=this._config,n,o,i=this._config){const a="单击动作"===e?"mdi:gesture-tap":"双击动作"===e?"mdi:gesture-double-tap":"按住动作"===e?"mdi:gesture-tap-hold":"mdi:gesture-tap",r="单击动作"===e?"tap_action":"双击动作"===e?"double_tap_action":"按住动作"===e?"hold_action":"开启动作"===e?"open_action":"close_action",s=o?`action_panel_${o}_${i}_${r}`:`action_panel_config_${r}`;let l;try{l="单击动作"===e?t.tap_action:"双击动作"===e?t.double_tap_action:"按住动作"===e?t.hold_action:"开启动作"===e?t.open_action:t.close_action}catch{}const d=t===this._config;return n||(n=d&&"单击动作"===e?"name"!==this._config.button_type?"more-info":"none":d?"none":""),c.qy`
            <ha-expansion-panel 
                outlined
