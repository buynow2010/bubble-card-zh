    ...
    <div class="module-editor-form">
        <div class="form-content">
          <h3>
            ...
            ${e._showNewModuleForm?"创建新模块":"default"===e._editingModule.id?"Edit Default Module":"Edit Module"}
          </h3>
              ...
              ${X(e,S,!!e._expandedPanelStates[S],()=>c.qy`
                ${M?c.qy`
                  <div class="bubble-info">
                    ...
                    <div class="content">
                      <p>Tap, double tap, and hold actions are disabled on this sub-button because "始终显示滑块" is enabled.</p>
                    </div>
                  </div>
                `:""}
              ...
              <div class="my-modules-top-row">
                ...
                <div class="my-modules-sort-menu">
                  ${G({trigger:c.qy`
                    ...
                    `,items:[{type:"checkbox",icon:"mdi:check-circle",label:"Active and recent first",checked:"default"===t,onClick:t=>{t.stopPropagation(),e._myModulesSortOrder="default";try{localStorage.setItem("bubble-card-modules-sort-order","default")}catch(e){}e.requestUpdate()}},{type:"checkbox",icon:"mdi:sort-alphabetical-ascending",label:"字母顺序",checked:"alphabetical"===t,onClick:t=>{t.stopPropagation(),e._myModulesSortOrder="alphabetical";try{localStorage.setItem("bubble-card-modules-sort-order","alphabetical")}catch(e){}e.requestUpdate()}},{type:"checkbox",icon:"mdi:clock-outline",label:"最近优先",checked:"recent-first"===t,onClick:t=>{t.stopPropagation(),e._myModulesSortOrder="recent-first";try{localStorage.setItem("bubble-card-modules-sort-order","recent-first")}catch(e){}e.requestUpdate()}}]})}
                </div>
              </div>
...
`;case"horizontal-buttons-stack":return function(e){if(!e.buttonAdded)for(e.buttonAdded=!0,e.buttonIndex=0;e._config[e.buttonIndex+1+"_link"];)e.buttonIndex++;return c.qy`
    ...
    `}(this);case void 0:return c.qy`
        ...
        `}makeDropdown(e,t,n,o,i){if(e.includes("icon")||e.includes("图标"))return c.qy`
            ...
            `}return c.qy`
                ...
                ></ha-form>
          `}_renderConditionalContent(e,t){return e?t:c.qy``}makeActionPanel(e,t=this._config,n,o,i=this._config){const a="Tap action"===e?"mdi:gesture-tap":"双击动作"===e?"mdi:gesture-double-tap":"按住动作"===e?"mdi:gesture-tap-hold":"mdi:gesture-tap",r="Tap action"===e?"tap_action":"双击动作"===e?"double_tap_action":"按住动作"===e?"hold_action":"开启动作"===e?"open_action":"close_action",s=o?`action_panel_${o}_${i}_${r}`:`action_panel_config_${r}`;let l;try{l="Tap action"===e?t.tap_action:"双击动作"===e?t.double_tap_action:"按住动作"===e?t.hold_action:"开启动作"===e?t.open_action:t.close_action}catch{}const d=t===this._config;return n||(n=d&&"Tap action"===e?"name"!==this._config.button_type?"more-info":"none":d?"none":""),c.qy`
            <ha-expansion-panel 
                outlined
              ...
              ${e._renderConditionalContent(s,c.qy`
                  ...
                  ${e._renderConditionalContent(!l,c.qy`
                      <ha-form
                          ...
                          .schema=${[{name:"main_buttons_alignment",selector:{select:{options:[{label:"Right (default)",value:"end"},{label:"居中",value:"center"},{label:"左侧",value:"start"},{label:"Space between",value:"space-between"}],mode:"dropdown"}}}]}
            ...
            <div class="content">
              ...
              ${e._renderConditionalContent(!u&&!h&&(b||!d&&!p),c.qy`
                <div class="bubble-info warning">
                  ...
                  <div class="content">
                    <p>Adding bottom sub-buttons will automatically switch this card to the "大尺寸" layout (this is the new recommended layout). This notice will disappear once you add bottom sub-buttons.</p>
                  </div>
                </div>
              `)}
              ${me(e,"bottom")}
    ...
    <div class="bubble-info">
      ...
      <div class="content">
        ...
        <p>Use <b>滑块</b> sub-buttons to control light brightness, media player volume, or climate temperature. Use <b>Dropdown</b> sub-buttons to select media sources, HVAC modes, or light effects. Use <b>默认</b> buttons for simple on/off controls or custom actions.</p>
